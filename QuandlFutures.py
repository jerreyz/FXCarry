...
class QuandlFuturesContract(object):
    ...
    def __init__(self, quandlCode,dateOfContract):
        ...
        self.quandlIdentifier = "%s/%s%s" % (self.QuandlCSV.loc[quandlCode,"MARKET"],quandlCode,quandl_date_id )
    ...
    def Get_prices_for_contract(self):
        contractdataprices = quandl.get(self.quandlIdentifier)
        return contractdataprices
